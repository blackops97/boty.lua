	...
	if settings.strict then
		...
		if msg.media then -- msg.media checks
			if msg.media.title then
				local is_link_title = msg.media.caption:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]/") or msg.media.caption:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]/") or msg.media.caption:match("[Tt].[Mm][Ee]/") or msg.media.caption:match("[Hh][Tt][Tt][Pp][Ss]://[Tt].[Mm][Ee]/") or msg.media.caption:match("[Hh][Tt][Tt][Pp]://[Tt].[Mm][Ee]/") or msg.media.caption:match(".[Cc][Oo][Mm]") or msg.media.caption:match("[Ww][Ww][Ww].")
		...
		--				kick_user(msg.from.id, msg.to.id)
			...
			if msg.media.description then
				local is_link_desc = msg.media.caption:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]/") or msg.media.caption:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]/") or msg.media.caption:match("[Tt].[Mm][Ee]/") or msg.media.caption:match("[Hh][Tt][Tt][Pp][Ss]://[Tt].[Mm][Ee]/") or msg.media.caption:match("[Hh][Tt][Tt][Pp]://[Tt].[Mm][Ee]/") or msg.media.caption:match(".[Cc][Oo][Mm]") or msg.media.caption:match("[Ww][Ww][Ww].")
	...
	--					kick_user(msg.from.id, msg.to.id)
		...
		if msg.fwd_from then
			if msg.fwd_from.title then
				local is_link_title = msg.media.caption:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]/") or msg.media.caption:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]/") or msg.media.caption:match("[Tt].[Mm][Ee]/") or msg.media.caption:match("[Hh][Tt][Tt][Pp][Ss]://[Tt].[Mm][Ee]/") or msg.media.caption:match("[Hh][Tt][Tt][Pp]://[Tt].[Mm][Ee]/") or msg.media.caption:match(".[Cc][Oo][Mm]") or msg.media.caption:match("[Ww][Ww][Ww].")h("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]/")
				if is_link_title and lock_link == "🔒" then
					delete_msg(msg.id, ok_cb, false)
					if strict == "🔒" or to_chat then
				--		kick_user(msg.from.id, msg.to.id)
